...
import { IoSearchOutline , IoBookmarkOutline , IoMailOutline , IoCallOutline, IoLocationOutline } from "react-icons/io5";
...
const AboutPage: React.FC = () => {
  ...
  <div>
    <section id="vision" className="container mx-auto py-12 px-4">
      <h1 className="text-3xl font-bold mb-5">우리의 비전</h1>
      <p className="text-lg mb-20">책과 사람을 연결하여 독서의 즐거움을 나누는 플랫폼입니다.</p>
    ...
    <section id="service" className="container mx-auto py-12 px-4">
      <h2 className="text-2xl font-bold mb-5">다양한 독서 경험을 제공합니다</h2>
      <p>
        우리 플렛폼은 사용자가 도서를 쉽게 검색하고 독서 토론에 참여할 수 있는 기회를 제공합니다. <br />
        또한, 다양한 커뮤니티 활동을 통해 독서의 즐거움을 나누고 소통할 수 있습니다.
      </p>
      <div className="flex justify-around mt-8">
        <div className="text-center">
          <IoSearchOutline size={32} className="mx-auto" />
          <h3 className="text-xl font-bold mt-2 mb-2">도서 검색 기능</h3>
          <p>
        ...
        <div className="text-center">
          ...
          <h3 className="text-xl font-bold mt-2 mb-2">독서 토론 참여</h3>
          <p>
        ...
        <div className="text-center">
          ...
          <h3 className="text-xl font-bold mt-2 mb-2">나만의 독서 기록 관리</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {[1, 2, 3].map((i) => (
          <div key={i} className="bg-white shadow p-4 rounded-md">
            ...
            <p className="font-semibold mt-2">"이곳에서 독서의 즐거움을 다시 찾았어요!"</p>
    ...
    <section id="info" className="container mx-auto py-12 px-4">
      <div className="flex justify-around mb-4">
        <div className="text-center">
          ...
          <h3 className="text-xl font-bold mt-2 mb-2">이메일</h3>
        ...
        <div className="text-center">
          ...
          <h3 className="text-xl font-bold mt-2 mb-2">전화</h3>
          <p>전화 문의는 언제든지 가능합니다.</p>
          <p>+82 (2) 1234-5678</p>
        </div>
        <div className="text-center">
          <IoLocationOutline size={32} className="mx-auto" />
          <h3 className="text-xl font-bold mt-2 mb-2">사무실</h3>
